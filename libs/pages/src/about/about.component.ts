...
export class AboutComponent implements OnInit {
  ...
  lines = [
    ...
    {
      class: 'text-muted',
      text: 'The repository is structured using <a href="https://github.com/nrwl/nx">@nrwl/nx</a>'
    },
    { class: 'text-info', text: `This app runs on <a href="https://angular.io/">Angular v${VERSION.full}</a>` },
    {
      class: 'text-success',
      text: `Server Side Rendering by <a href="https://github.com/angular/universal">Angular Universal</a>`
    },
